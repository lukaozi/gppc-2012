...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cpd-DEBUG-ONLY

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cpd-DEBUG-ONLY: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cpd-DEBUG-ONLY ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/src/ParamManager.o: src/ParamManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ParamManager.o src/ParamManager.cpp
...
${OBJECTDIR}/src/Scenario.o: src/Scenario.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Scenario.o src/Scenario.cpp
...
${OBJECTDIR}/src/CPD2.o: src/CPD2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CPD2.o src/CPD2.cpp
...
${OBJECTDIR}/src/SlimmerRectangle.o: src/SlimmerRectangle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SlimmerRectangle.o src/SlimmerRectangle.cpp

${OBJECTDIR}/src/RectangleSplitter.o: src/RectangleSplitter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/RectangleSplitter.o src/RectangleSplitter.cpp

${OBJECTDIR}/src/MapCpd.o: src/MapCpd.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MapCpd.o src/MapCpd.cpp

${OBJECTDIR}/src/ScenarioRM.o: src/ScenarioRM.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ScenarioRM.o src/ScenarioRM.cpp

${OBJECTDIR}/src/QuadTree.o: src/QuadTree.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/QuadTree.o src/QuadTree.cpp

${OBJECTDIR}/src/AbstractCPD.o: src/AbstractCPD.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/AbstractCPD.o src/AbstractCPD.cpp

${OBJECTDIR}/src/Tile.o: src/Tile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Tile.o src/Tile.cpp

${OBJECTDIR}/src/DijkstraNode.o: src/DijkstraNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/DijkstraNode.o src/DijkstraNode.cpp

${OBJECTDIR}/src/GenericNode.o: src/GenericNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/GenericNode.o src/GenericNode.cpp

${OBJECTDIR}/src/TableCompresser1.o: src/TableCompresser1.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TableCompresser1.o src/TableCompresser1.cpp

${OBJECTDIR}/src/CompressedMoveDatabase.o: src/CompressedMoveDatabase.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CompressedMoveDatabase.o src/CompressedMoveDatabase.cpp

${OBJECTDIR}/src/QTDatabase.o: src/QTDatabase.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/QTDatabase.o src/QTDatabase.cpp

${OBJECTDIR}/src/ScenarioLoader.o: src/ScenarioLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ScenarioLoader.o src/ScenarioLoader.cpp

${OBJECTDIR}/src/GridMap.o: src/GridMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/GridMap.o src/GridMap.cpp

${OBJECTDIR}/src/AbstractGraphEdge.o: src/AbstractGraphEdge.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/AbstractGraphEdge.o src/AbstractGraphEdge.cpp

${OBJECTDIR}/src/MoveTable.o: src/MoveTable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MoveTable.o src/MoveTable.cpp

${OBJECTDIR}/src/SubstringManager.o: src/SubstringManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SubstringManager.o src/SubstringManager.cpp

${OBJECTDIR}/src/utils2.o: src/utils2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/utils2.o src/utils2.cpp

${OBJECTDIR}/src/TableCompresser.o: src/TableCompresser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TableCompresser.o src/TableCompresser.cpp

${OBJECTDIR}/src/ReachabilityTable.o: src/ReachabilityTable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ReachabilityTable.o src/ReachabilityTable.cpp

${OBJECTDIR}/src/AbstractGraph.o: src/AbstractGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/AbstractGraph.o src/AbstractGraph.cpp

${OBJECTDIR}/src/globals.o: src/globals.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/globals.o src/globals.cpp

${OBJECTDIR}/src/SlimRectangle.o: src/SlimRectangle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SlimRectangle.o src/SlimRectangle.cpp

${OBJECTDIR}/src/Entry.o: src/Entry.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Entry.o src/Entry.cpp

${OBJECTDIR}/src/AbstractGraphNode.o: src/AbstractGraphNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/AbstractGraphNode.o src/AbstractGraphNode.cpp

${OBJECTDIR}/src/GenericEdge.o: src/GenericEdge.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/GenericEdge.o src/GenericEdge.cpp

${OBJECTDIR}/src/CompressedTable.o: src/CompressedTable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CompressedTable.o src/CompressedTable.cpp

${OBJECTDIR}/src/GenericMap.o: src/GenericMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/GenericMap.o src/GenericMap.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cpd-DEBUG-ONLY
